...
var ImageViewer = /** @class */ (function (_super) {
    ...
    ImageViewer.prototype.init = function (nextProps) {
        ...
        var loadingImages = nextProps.imageUrls.map(function () { return ({ loading: false }); });
        this.setState({
            currentShowIndex: nextProps.index,
     ...
     * 加载图片，主要是获取图片长与宽
     */
    ImageViewer.prototype.updateImageSize = function (index, width, height) {
        var _a = this.state.imageSizes, imageSizes = _a === void 0 ? [] : _a;
        imageSizes[index] = {
            width: width,
            height: height,
            status: 'success'
    ...
    ImageViewer.prototype.updateLoadingState = function (index, loading) {
        var _a = this.state.loadingImages, loadingImages = _a === void 0 ? [] : _a;
        loadingImages[index] = {
            loading: loading
        };
        this.setState({
